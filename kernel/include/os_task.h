...
#define OS_TASK_STACK_DEFINE(name, size)    \
    OS_ALIGN(OS_ARCH_STACK_ALIGN_SIZE) os_uint8_t stack_##name[OS_ALIGN_UP(size, OS_ARCH_STACK_ALIGN_SIZE)]
#define OS_TASK_STACK_BEGIN_ADDR(name)      (void *)&stack_##name[0]
#define OS_TASK_STACK_SIZE(name)            sizeof(stack_##name)
