...
def bs_update_ide_project(bsp_root, os_root, studio_proj = None):
    ...
    for item in tgt_dict:
        child = subprocess.run('scons --ide=' + item, cwd=bsp_root,
